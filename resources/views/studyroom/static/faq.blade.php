...
@section('pageCSS')
    @vite('resources/css/studyroom/styleInfo.css',
...
<section class="info-container">
    ...
    <details class="faq-item">
        ...
        <p class="faq-answer">
            Sono accettati solo file PDF. Contenuti non pertinenti allo studio verranno rimossi dagli amministratori, inoltre se l'utente non rispetta le linee guida
            il suo account potrà essere sospeso.
        </p>
    </details>
